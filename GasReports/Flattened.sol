...
// File contracts/example/interfaces/ICakePool.sol
...
// File contracts/example/interfaces/IPancakeswapFarm.sol
...
// File @openzeppelin/contracts/interfaces/IERC20.sol@v4.8.1
...
// File contracts/example/Test.sol
...
contract StrategyChefV2 is ReentrancyGuard, Pausable {
    ...
    function deposit(uint256 _wantAmt) external onlyMasterChef whenNotPaused nonReentrant returns (uint256) {
    ...
    function withdraw(uint256 _wantAmt) external onlyMasterChef nonReentrant returns (uint256) {
